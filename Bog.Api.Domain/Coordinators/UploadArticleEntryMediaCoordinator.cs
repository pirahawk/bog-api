...
namespace Bog.Api.Domain.Coordinators
{
    public class UploadArticleEntryMediaCoordinator : IUploadArticleEntryMediaCoordinator
    {
        ...
        public async Task UploadEntryMedia(ArticleEntryMediaRequest entryMediaRequest, EntryMedia articleEntryMedia)
        {
            ...
            await _blobStore.PersistArticleEntryMedia( articleEntryMedia.Id, 
